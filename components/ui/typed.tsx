...
const AnimatedText = ({ 
  ...
  const createPartialElement = (element: any, length: number): ReactNode => {
    ...
    if (Array.isArray(element.props.children)) {
      newChildren = element.props.children.map((child: any) => {
  ...
  }, [displayLength, currentIndex, isTyping, elements, typeSpeed, pauseDuration]);
