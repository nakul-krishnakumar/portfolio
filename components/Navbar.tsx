...
const Navbar = () => {
    const TABS = [
        {
            label: 'About',
            icon: <Link href="#home"><User className='navbar_icons' /></Link>,
        },
        {
            label: 'Skills',
            icon: <Link href="#skills"><Brain className='navbar_icons' /></Link>,
        },
        {
            label: 'Projects',
            icon: <Link href="#projects"><FolderCode className='navbar_icons' /></Link>,
        },
        {
            label: 'Achievements',
            icon: <Link href="#achievements"><Trophy className='navbar_icons' /></Link>,
        },
        {
            label: 'Contact Me',
            icon: <Link href="#contactme"><ContactRound className='navbar_icons' /></Link>,
        },
    ];
